...
class RentListingActivityScope {
  const RentListingActivityScope({
  ...
  factory RentListingActivityScope.fromRoute() {
    var propertyId = '';
    var propertyName = '';
    ...
    return RentListingActivityScope(
...
class RentListingActivityLoader {
  RentListingActivityLoader({
  ...
  Future<List<ListingActivityVm>> load({
    required RentListingActivityScope scope,
    int? limit,
  }) async {
  ...
  Future<Set<String>> _listingPropertyRefs(RentListingActivityScope scope) async {
    final refs = <String>{};
  ...
  Future<PropertyRecord?> _findLocalPropertyRow(RentListingActivityScope scope) async {
    try {
  ...
  bool _maintenanceMatchesListing(
    ...
    RentListingActivityScope scope,
  ...
  String _relativeDate(RentListingActivityScope scope, String iso, int ms) {
    DateTime d;
    try {
  ...
  String _relativeDateFromMs(RentListingActivityScope scope, int ms) {
