...
class TicketView extends StatelessWidget {
  ...
  const TicketView({super.key, 
    ...
    this.trianglePos = AppValues.point_seven,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
//      foregroundPainter: TicketClipper(cornerRadius, horizontal, vertical, triangleSize, trianglePos),
    ...
    if (start.dx == end.dx) {
      ...
      if (end.dy > start.dy) {
        ...
        for (int i = 0; numOfArc > i; i++) {
          path.relativeLineTo(0, radius * AppValues.point_five);
      ...
      if (end.dx > start.dx) {
        ...
        for (int i = 0; numOfArc > i; i++) {
          path.relativeLineTo(radius * AppValues.point_five, 0);
